...
public class PushTranslationCommand extends BaseCommandImpl {
    ...
    public void process(final RESTManager restManager, final ErrorLoggerManager elm, final RESTUserV1 user) {
        ...
        if (topics == null) topics = new RESTTopicCollectionV1();
    ...
    protected boolean pushCSTopicsToZanata(final RESTManager restManager, final RESTTopicCollectionV1 topics,
            final RESTTopicV1 contentSpecTopic, final ContentSpec contentSpec) {
        ...
        if (answer.equalsIgnoreCase("yes") || answer.equalsIgnoreCase("y")) {
            ...
            for (final Entry<RESTTopicV1, Document> topicEntry : topicToDoc.entrySet()) {
                ...
                if (zanataFile == null) {
                    final boolean translatedTopicExists = restManager.getReader().getTranslatedTopicByTopicId(topic.getId(),
            ...
            if (!topicsOnly) {
                ...
                if (zanataFile == null) {
                    final boolean translatedTopicExists = restManager.getReader().getTranslatedContentSpecById(contentSpecTopic.getId(),
                            contentSpecTopic.getRevision(), contentSpecTopic.getLocale()) != null;
