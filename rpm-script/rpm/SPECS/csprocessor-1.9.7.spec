...
%changelog
* Wed Jul 29 2015 lnewson - 1.9.7-0
- CCS-86. Added a way to build with validation/condition processing disabled.
* Tue Feb 17 2015 lnewson - 1.9.6-2
- Fixed some issues building PO files.
* Fri Nov 07 2014 lnewson - 1.9.6
- Removed keywordset generation from the builder.
* Mon Sep 29 2014 lnewson - 1.9.5
- BZ #1144908 - csprocessor assemble fails when "--format publican-po" is selected.
- Partial fix for BZ #1144184 - Print a nice error when a process is already running for a content spec.
* Tue Sep 16 2014 lnewson - 1.9.4
- Added de-DE, it-IT, ko-KR, ru-RU and zh-TW translations for builds.
- BZ #1140879 - Builds fail when using Java 6.
* Wed Sep 10 2014 lnewson - 1.9.3
- Added fr-FR translations for builds.
* Thu Sep 04 2014 lnewson - 1.9.2
- BZ #1136688 - Translation builds failing where there is newer en-US content.
- Minor performance enhancements.
* Mon Sep 01 2014 lnewson - 1.9.1
- Fixed a regression that removed the 1.8.1 additions.
...
- BZ #1110612 - Add a way to specify 'docname' for publican builds that won't be overwritten.
- BZ #1112049 - Fixed URL validation pass fails silently.
* Wed Jun 25 2014 lnewson - 1.7.1
- Fixed an issue where the builder would produce invalid po files.
- Fixed an issue where &quot; and &apos; weren't being escaped.
...
- BZ #1103542 - Can not build translated books with editor links.
* Thu May 29 2014 lnewson - 1.6.1
- Fixed an issue where translated images weren't being download correctly.
...
- BZ #1069935 - ID attribute assigned to section must be unique.
...
- BZ #1091773 - Additional Files cause translated builds to fail.
